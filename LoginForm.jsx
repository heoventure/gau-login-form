...
export default function LoginForm({ 
  ...
  return (
    ...
    >
      ...
      {/* Social login options - Horizontal Layout */}
      <div className="mt-6">
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className="flex items-center justify-center p-3 border border-gray-200 rounded-lg bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors flex-1"
      ...
      <div className="mt-8 text-center flex items-center justify-center gap-2">
        ...
        <button
          ...
          className="text-sm text-blue-600 hover:text-blue-800 font-semibold focus:outline-none focus:underline"
          tabIndex={0}
        >
          Sign up for free
        </button>
