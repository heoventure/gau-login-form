...
export default function LoginForm({ 
  ...
  useEffect(() => {
    ...
    // Track engagement after 5 seconds (Adjusted Bounce Rate)
    // Users who stay for >5s are reading/considering, not bouncing immediately.
    const engagementTimer = setTimeout(() => {
      metricsTracker.trackInteraction('viewed_5s');
    }, 5000);
    
    // Autofocus email field for better UX (Desktop only ideally)
  ...
  return (
    ...
    >
      ...
      {/* Social login options - Prioritized for lower friction */}
      <div className="flex flex-col gap-3 mb-6">
        <button
          type="button"
          onClick={() => handleSocialLogin('Google')}
          className="flex items-center justify-center w-full py-2.5 px-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors shadow-sm text-sm font-medium text-gray-700"
        ...
        >
          <svg className="w-5 h-5 mr-3" fill="#1877F2" viewBox="0 0 24 24">
            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.65.235 2.65.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
          </svg>
      ...
      <div className="mt-6 text-center">
        ...
        <button
          ...
          className="w-full py-2.5 px-4 bg-gray-50 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all"
        >
          Sign up for free
        </button>
      </div>
