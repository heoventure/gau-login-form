...
export default function LoginForm({ 
  ...
  return (
    <form
      ...
      className="w-full max-w-md mx-auto p-6 sm:p-8 bg-white rounded-xl shadow-lg border border-gray-100"
      aria-label="Login form"
    >
      {/* Security message - moved to prominent position */}
      ...
      <div className="mb-6 space-y-3">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
          >
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          ...
          className="text-sm text-blue-600 hover:text-blue-800 font-medium focus:outline-none focus:underline focus:ring-2 focus:ring-blue-500 rounded px-1 self-start sm:self-auto"
          tabIndex={0}
        >
          Forgot password?
        </button>
